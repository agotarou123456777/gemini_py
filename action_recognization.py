...
IMAGE_OVERLAP_NUM     = 1   # 問い合わせ重複画像数
...
'''2枚目以降の問い合わせに付与するテキスト'''
secondary_prompt = \
"""\
引き続き、添付する画像で同じ作業を続けてください
"""
...
num_loop = getLoopCount(max_image_each_query=MAX_IMAGES_EACH_QUERY, num_overlap=IMAGE_OVERLAP_NUM) + 1
